...
extension ChatModel {
    static func dummy() -> [ChatModel] {
        return [
            ...
            ChatModel(profileImg: .profile4, name: "김나연", place: "미국", message: "타코팔러가야돼", itemImg: .product5),
            ...
            ChatModel(profileImg: .profile10, name: "김한열", place: "뭘보슈", message: "생일추카해한열오빠", itemImg: .product1)
        ]
    }
}
